...
function generateQuery1(covidStatus, season, crimeGroups) {
    ...
    if(season == 1){
        ...
        seasonCovidTypeQuery = "((l.DATE_RPTD >= '01-JUN-2020' AND l.DATE_RPTD <= '31-AUG-2020') OR (l.DATE_RPTD >= '01-JUN-2021' AND l.DATE_RPTD <= '31-AUG-2021') OR (l.DATE_RPTD >= '01-JUN-2022' AND l.DATE_RPTD <= '31-AUG-2022')) AND l.DATE_RPTD IS NOT NULL";
        ...
        seasonCovidTypeQuery = "(l.DATE_RPTD >= '01-SEP-2020' AND l.DATE_RPTD <= '31-NOV-2020') OR (l.DATE_RPTD >= '01-SEP-2021' AND l.DATE_RPTD <= '31-NOV-2021') OR (l.DATE_RPTD >= '01-SEP-2022' AND l.DATE_RPTD <= '31-NOV-2022')) AND l.DATE_RPTD IS NOT NULL";
        ...
        seasonCovidTypeQuery = "((l.DATE_RPTD >= '01-JAN-2020' AND l.DATE_RPTD <= '28-FEB-2020') OR (l.DATE_RPTD >= '01-DEC-2020' AND l.DATE_RPTD <= '31-DEC-2020')) OR ((l.DATE_RPTD >= '01-JAN-2021' AND l.DATE_RPTD <= '28-FEB-2021') OR (l.DATE_RPTD >= '01-DEC-2021' AND l.DATE_RPTD <= '31-DEC-2021')) OR ((l.DATE_RPTD >= '01-JAN-2022' AND l.DATE_RPTD <= '28-FEB-2022')) OR (l.DATE_RPTD >= '01-DEC-2022' AND l.DATE_RPTD <= '31-DEC-2022')) OR ((l.DATE_RPTD >= '01-JAN-2023' AND l.DATE_RPTD <= '28-FEB-2023'))) AND l.DATE_RPTD IS NOT NULL";
