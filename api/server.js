...
const user = "chewitt1";//Could not get the env file to work
const password = "WztwDPVQCbNyDGfJShV7dhYq";
...
function generateQuery4(covidStatus, season, crimeGroups) {
    let seasonCovidTypeQuery;
    let seasonCrimeTypeQuery; 
    let crimeGroupsQuery = "cg.CRIME_GROUP = '" + crimeGroups.split('#').join("' OR cg.CRIME_GROUP = '") + "'";
    let covidStatusQuery;
...
function generateQuery5(covidStatus, season, crimeGroups) {
    let seasonCovidTypeQuery;
    let seasonCrimeTypeQuery; 
    let crimeGroupsQuery = "cg.CRIME_GROUP = '" + crimeGroups.split('#').join("' OR cg.CRIME_GROUP = '") + "'";
    let covidStatusQuery;
